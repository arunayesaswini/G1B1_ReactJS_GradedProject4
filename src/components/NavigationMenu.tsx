      ...
      <Navbar bg="light" variant="light" className='links'>
        <Container>
          ...
          <Nav className="me-auto">
            ...
            <Nav.Link ref={favouriteRef} className={`links-style`} onClick={() => { newTabClick('favourite'); changeColor(favouriteRef) }}>Favourites</Nav.Link>
          ...
          <Form className="d-flex">
            <Form.Control
              ...
              className="me-2"
              aria-label="Search"
              onChange={() => funsetSearchText(searchRef?.current?.value as string)}
            />
            <Button variant="outline-primary"> <FontAwesomeIcon icon={faSearch} style={{ color: 'black' }} /></Button>
          </Form>
        </Container>
      </Navbar>
